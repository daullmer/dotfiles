...
cp -R /Library/Preferences/ ~/Desktop/Global-Preferences.backup
...
# Trackpad: map two finger click to right-click
...
defaults write org.gpgtools.gpgmail SignNewEmailsByDefault -bool false
